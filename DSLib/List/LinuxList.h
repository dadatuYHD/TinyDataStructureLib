...
static void __list_add(struct list_head *_new_,
...
#else
extern void __list_add(struct list_head *_new_,
                  struct list_head *prev,
                  struct list_head *next);
#endif
 ...
 */
static void list_add(struct list_head *_new_, struct list_head *head)
{
 ...
 */
static void list_add_tail(struct list_head *_new_, struct list_head *head)
{
